...
export const ocbcHistory: RateSnapshot[] = [
  {
    ...
    changeSummary: "Salary +1.6/+3.2%, Save +0.6/+1.2%,\nSpend +0.5% both tiers, Insurance +1.2/+2.4%,\nInvest +1.2/+2.4%, $250K +2.2% both.",
  ...
  },
  {
    ...
    changeSummary: "Salary ↓1.2/+2.4%, Save ↓0.4/+0.8%,\nSpend ↓0.4% both, Ins/Invest unchanged, $250K ↓2% both.",
  ...
  },
  {
    ...
    changeSummary: "Salary ↓1/+2%, Save unchanged, Spend ↓0.25% both,\nIns/Invest ↓1/+2%, $250K ↓1.2% both.",
