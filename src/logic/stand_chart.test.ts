...
describe("Standard Chartered I/R (Jun 2026)", () => {
  const tests: {
  ...
  }[] = [
    {
      ...
      expectedInterest: new ResultInterest(5850, 100000),
    },
    {
      ...
      expectedInterest: new ResultInterest(5900, 200000),
    },
    {
    ...
    },
    {
      ...
      expectedInterest: new ResultInterest(1850, 100000),
    },
    {
    ...
    },
    {
      ...
      expectedInterest: new ResultInterest(950, 100000),
    },
    {
      ...
      expectedInterest: new ResultInterest(475, 50000),
    },
    {
  ...
  for (const testCase of tests) {
    it(testCase.name, () => {
      const result = stand_chart_interest_06_2026(testCase.profile);
      expect(result).toEqual(testCase.expectedInterest);
    });
  }
});

describe("Standard Chartered I/R (Oct 2025)", () => {
  const tests: {
    name: string;
    profile: Profile;
    expectedInterest: ResultInterest;
