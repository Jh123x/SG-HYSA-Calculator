...
export const bank_of_china_smart_saver_08_2025 = (profile: Profile): ResultInterest => {
...
export const bank_of_china_smart_saver_11_2025 = (profile: Profile): ResultInterest => {
    const { Savings, Insurance, Spending, Salary, GiroTransactions } = profile;
    if (Savings < 1_500) return new ResultInterest(0, Savings);
...
export const bank_of_china_super_saver_07_2025 = (profile: Profile): ResultInterest => {
...
export const bank_of_china_super_saver_08_2025 = (profile: Profile): ResultInterest => {
    const { Savings } = profile;
    if (Savings < 200) return new ResultInterest(0, Savings);
...
export const bank_of_china_super_saver_11_2025 = (profile: Profile): ResultInterest => {
    const { Savings } = profile;
    if (Savings < 200) return new ResultInterest(0, Savings);
